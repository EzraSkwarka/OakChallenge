...
window.gameData = {
  gameId: "sapphire",
  gameTitle: "Sapphire",
  logo: "assets/images/logos/sapphire.png",
  aboutHtml: `
  ...
  `,
      ...
      rows: [
...

        {
          ...
          method: "(Ruby) Catch on Route 102",
        },
        {
          pokemon: {
  ...
  `,
    ...
    mossdeep: {
      ...
      summaryHtml: `
        ...
        <h5>Route 119</h5>
        <p>
          North from Route 118 you can catch a Tropius in the tall grass.
        </p>
        <pre>
          Tropius
        </pre>
        ...
        <h5>Mossdeep City</h5>
        <p>
          Surf east from Lilycove all the way to Mossdeep City. A couple of things to grab, get HM08 from Steven’s house, the Super Rod from the fisherman and a Sun Stone from the space center if you’re playing Sapphire.
        </p>
        <pre>
  ...
  `,
      ...
      rows: [
        ...
        },
        {
          ...
          method: "Use a Moon Stone on Jigglypuff (steal from Lunatone)",
        },
        {
          pokemon: {
        ...
        /* --------------------------- Mossdeep, Stones ----------------------- */
        {
          ...
          method: "Use a Sun Stone on Gloom (Mossdeep Space Center)",
        },
    ...
    sootopolis: {
      ...
      summaryShort: `Defeating Tate and Liza now lets you Dive underwater. Dive down there to search for some underwater pokemon! The best place would be outside Sootopolis City where you fill find in the seaweed:`,
      summaryHtml: `
      <p>
  ...
  `,
      ...
      rows: [
        ...
        /* --------------------------- Version-specific Water Stone target ----- */
        {
          pokemon: {
            img: imgBasehref + "272.png",
            name: "Ludicolo",
          },
          method: "Use a Water Stone on Lombre",
        },
  ...
  `,
    ...
    "post-game": {
      ...
      headerImgAlt: "Prof Oak as he appeared in Pokemon Ruby and Sapphire",
      ...
      summaryHtml: `
        ...
        <p>
          ...
          Hoenn Dex Caught 178, Remaining 24<br/>
        </p>
