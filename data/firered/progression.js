  ...
  progression: {
    ...
    "Pre Badge 2: Misty": {
      ...
      rows: [
        ...
        /* --------------------------- Wild Pokémon ---------------------------- */
        {
          pokemon: { img: "/assets/images/FRLG/Spr_3f_023.png", name: "Ekans" },
    ...
    "Post Game": {
      ...
      rows: [
        ...
        {
          pokemon: { img: "link", name: "Flareon" },
          method: "Use a Fire Stone on Eevee (Four Island Nursery)",
          caught: false,
          requires: { eeveelution: "jolteon" },
        },
        {
          pokemon: { img: "link", name: "Vaporeon" },
        ...
        {
          pokemon: { img: "link", name: "Pichu" },
          method: "Breed Pikachu/Raichu",
          caught: false,
        },
        {
          pokemon: { img: "link", name: "Cleffa" },
          method: "Breed Clefairy/Clefable",
          caught: false,
        },
        {
          pokemon: { img: "link", name: "Igglybuff" },
          method: "Breed Jigglypuff/Wigglytuff",
          caught: false,
        },
        {
          pokemon: { img: "link", name: "Smoochum" },
          method: "Breed Jynx",
          caught: false,
        },
        {
          pokemon: { img: "link", name: "Elekid" },
        ...
        {
          pokemon: { img: "link", name: "Slugma" },
          method: "Mt. Ember (newly opened area)",
          caught: false,
        },
        {
          pokemon: { img: "link", name: "Magcargo" },
        ...
        /* --------------------------- Three Island ---------------------------- */
        {
          pokemon: { img: "link", name: "Dunsparce" },
        ...
        {
          pokemon: { img: "link", name: "Wooper" },
          method: "Four Island lake / Icefall Cave",
          caught: false,
        },
        {
          pokemon: { img: "link", name: "Quagsire" },
          method: "Evolve from Wooper at level 20",
          caught: false,
        },
        {
          pokemon: { img: "link", name: "Delibird" },
          method: "Icefall Cave",
          caught: false,
        },
        {
          pokemon: { img: "link", name: "Swinub" },
          method: "Icefall Cave",
          caught: false,
        },
        {
          pokemon: { img: "link", name: "Piloswine" },
        ...
        /* --------------------------- Six Island ---------------------------- */
        {
          pokemon: { img: "link", name: "Yanma" },
          method: "Ruin Valley / Pattern Bush approaches",
          caught: false,
        },
        {
          pokemon: { img: "link", name: "Natu" },
          method: "Six Island (Ruin Valley/grass)",
          caught: false,
        },
        {
          pokemon: { img: "link", name: "Xatu" },
          method: "Evolve from Natu at level 25",
          caught: false,
        },
        {
          pokemon: { img: "link", name: "Wobbuffet" },
          method: "Six Island grass (safari-style areas)",
          caught: false,
        },
        {
          pokemon: { img: "link", name: "Spinarak" },
          method: "Pattern Bush",
          caught: false,
        },
        {
          pokemon: { img: "link", name: "Ariados" },
          method: "Evolve from Spinarak at level 22",
          caught: false,
        },
        {
          pokemon: { img: "link", name: "Ledyba" },
          method: "Pattern Bush",
          caught: false,
        },
        {
          pokemon: { img: "link", name: "Ledian" },
          method: "Evolve from Ledyba at level 18",
          caught: false,
        },
        {
          pokemon: { img: "link", name: "Heracross" },
          method: "Pattern Bush",
          caught: false,
        },
        {
          pokemon: { img: "link", name: "Wynaut" },
        ...
        {
          pokemon: { img: "link", name: "Lugia" },
          method: "Navel Rock (Switch re‑release ticket)",
          caught: false,
        },
        {
          pokemon: { img: "link", name: "Ho-Oh" },
          method: "Navel Rock (Switch re‑release ticket)",
          caught: false,
        },
        {
          pokemon: { img: "link", name: "Deoxys" },
