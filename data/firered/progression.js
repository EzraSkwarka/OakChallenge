  ...
  progression: {
    ...
    "Pre Badge 2: Misty": {
      ...
      rows: [
        ...
        {
          pokemon: { img: imgBasehref + "023.png", name: "Ekans" },
          method: "Catch on Route 4",
        },
        {
          pokemon: { img: imgBasehref + "024.png", name: "Arbok" },
    ...
    "Pre Badge 4: Blaine": {
      ...
      summaryShort: "With Surf available, prioritize water routes, the Power Plant, and Cinnabar (fossils), then proceed toward your fourth badge.",
