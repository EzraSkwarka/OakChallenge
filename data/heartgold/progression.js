...
const badgeBasehref = "assets/images/HeartGold and SoulSilver/badges/Spr_HGSS_";
...
window.gameData = {
  ...
  progression: {
    falkner: {
      ...
      rows: [
        ...
        /* ================= Route 30 ================= */
        { pokemon: { img: imgBasehref + "010.png", name: "Caterpie" }, method: "Route 30 (morning/day)" },
        ...
        { pokemon: { img: imgBasehref + "013.png", name: "Weedle" }, method: "Route 30 (morning/day)" },
        ...
        { pokemon: { img: imgBasehref + "167.png", name: "Spinarak" }, method: "Route 30 (night)" },
        { pokemon: { img: imgBasehref + "168.png", name: "Ariados" }, method: "Evolve Spinarak at level 22" },

        { pokemon: { img: imgBasehref + "165.png", name: "Ledyba" }, method: "Route 30 (morning)" },
        ...
        { pokemon: { img: imgBasehref + "023.png", name: "Ekans" }, method: "Route 32" },
  ...
  `,
      ...
      rows: [
        ...
        { pokemon: { img: imgBasehref + "027.png", name: "Sandshrew" }, method: "Union Cave" },
    ...
    whitney: {
      ...
      rows: [
        ...
        { pokemon: { img: imgBasehref + "023.png", name: "Ekans" }, method: "Goldenrod Game Corner" },
        { pokemon: { img: imgBasehref + "024.png", name: "Arbok" }, method: "Evolve Ekans at level 22" },

        { pokemon: { img: imgBasehref + "027.png", name: "Sandshrew" }, method: "Goldenrod Game Corner" },
        { pokemon: { img: imgBasehref + "028.png", name: "Sandslash" }, method: "Evolve Sandshrew at level 22" },
        ...
        { pokemon: { img: imgBasehref + "013.png", name: "Weedle" }, method: "Bug Catching Contest" },
        { pokemon: { img: imgBasehref + "014.png", name: "Kakuna" }, method: "Evolve Weedle at level 7" },
        { pokemon: { img: imgBasehref + "015.png", name: "Beedrill" }, method: "Evolve Kakuna at level 10" },

        { pokemon: { img: imgBasehref + "010.png", name: "Caterpie" }, method: "Bug Catching Contest" },
        { pokemon: { img: imgBasehref + "011.png", name: "Metapod" }, method: "Evolve Caterpie at level 7" },
        { pokemon: { img: imgBasehref + "012.png", name: "Butterfree" }, method: "Evolve Metapod at level 10" },
        ...
        /* ================= Route 36 ================= */
        { pokemon: { img: imgBasehref + "058.png", name: "Growlithe" }, method: "Route 36" },
        { pokemon: { img: imgBasehref + "037.png", name: "Vulpix" }, method: "Route 36" },
        ...
        { pokemon: { img: imgBasehref + "059.png", name: "Arcanine" }, method: "Use Fire Stone on Growlithe" },
        { pokemon: { img: imgBasehref + "038.png", name: "Ninetales" }, method: "Use Fire Stone on Vulpix" }
      ]
    },
    morty: {
      ...
      rows: [
        ...
        { pokemon: { img: imgBasehref + "052.png", name: "Meowth" }, method: "Route 38 / 39" },
        ...
        /* ================= Route 42 ================= */
        { pokemon: { img: imgBasehref + "056.png", name: "Mankey" }, method: "Route 42" },
    ...
    pryce: {
      ...
      summaryHtml: `
        ...
        `,
      rows: [
        /* ================= Route 41 ================= */ { pokemon: { img: imgBasehref + "226.png", name: "Mantine" }, method: "Route 41 (Surf)" },
    ...
    clair: {
      ...
      rows: [
        ...
        { pokemon: { img: imgBasehref + "225.png", name: "Delibird" }, method: "Ice Path" },

        /* ================= Blackthorn City / Route 45 ================= */
        { pokemon: { img: imgBasehref + "231.png", name: "Phanpy" }, method: "Route 45 grass" },
        { pokemon: { img: imgBasehref + "232.png", name: "Donphan" }, method: "Evolve Phanpy at level 25" },

        { pokemon: { img: imgBasehref + "207.png", name: "Gligar" }, method: "Route 45 grass" },

        { pokemon: { img: imgBasehref + "216.png", name: "Teddiursa" }, method: "Route 45 grass" },
        { pokemon: { img: imgBasehref + "217.png", name: "Ursaring" }, method: "Evolve Teddiursa at level 30" },

        { pokemon: { img: imgBasehref + "227.png", name: "Skarmory" }, method: "Route 45 grass" }
      ]
    },
    "pre-elite-4": {
      ...
      rows: [
        ...
        /* ================= Box Legendary ================= */
        { pokemon: { img: imgBasehref + "250.png", name: "Ho-Oh" }, method: "Bell Tower after Kimono Girls" },
        { pokemon: { img: imgBasehref + "249.png", name: "Lugia" }, method: "Whirl Islands after Kimono Girls" },
    ...
    misty: {
      ...
      rows: [
        ...
        { pokemon: { img: imgBasehref + "271.png", name: "Lombre" }, method: "Safari Zone plains (14 Plains objects)" },
        ...
        { pokemon: { img: imgBasehref + "332.png", name: "Cacturne" }, method: "Safari Zone savannah (20 Days, 18 Forest objects)" },
        ...
        { pokemon: { img: imgBasehref + "314.png", name: "Illumise" }, method: "Safari Zone wasteland (30 days)" },
        ...
        { pokemon: { img: imgBasehref + "336.png", name: "Seviper" }, method: "Safari Zone marshland (70 days)" },
        ...
        { pokemon: { img: imgBasehref + "302.png", name: "Sableye" }, method: "Swarm" },
        { pokemon: { img: imgBasehref + "303.png", name: "Mawile" }, method: "Swarm" },

        { pokemon: { img: imgBasehref + "316.png", name: "Gulpin" }, method: "Swarm" },
        ...
        { pokemon: { img: imgBasehref + "343.png", name: "Baltoy" }, method: "Swarm" },
        ...
        { pokemon: { img: imgBasehref + "138.png", name: "Omanyte" }, method: "Resurrect fossil" },
        { pokemon: { img: imgBasehref + "139.png", name: "Omastar" }, method: "Evolve Omanyte at level 40" },
        { pokemon: { img: imgBasehref + "140.png", name: "Kabuto" }, method: "Resurrect fossil" },
        { pokemon: { img: imgBasehref + "141.png", name: "Kabutops" }, method: "Evolve Kabuto at level 40" },

        { pokemon: { img: imgBasehref + "249.png", name: "Lugia" }, method: "Whirl Islands" },
        { pokemon: { img: imgBasehref + "250.png", name: "Ho-Oh" }, method: "Ecruteak City" },
        ...
        /* ================= Evolution Items ================= */
        { pokemon: { img: imgBasehref + "472.png", name: "Gliscor" }, method: "Level up Gligar at night holding Razor Fang" },
        ...
        /* ================= Cliff Cave Fossils ================= */
        { pokemon: { img: imgBasehref + "347.png", name: "Anorith" }, method: "Resurrect Claw Fossil" },
        { pokemon: { img: imgBasehref + "348.png", name: "Armaldo" }, method: "Evolve Anorith at level 40" },
        { pokemon: { img: imgBasehref + "345.png", name: "Lileep" }, method: "Resurrect Root Fossil" },
        { pokemon: { img: imgBasehref + "346.png", name: "Cradily" }, method: "Evolve Lileep at level 40" },

        /* ================= Roaming Legendary ================= */
        { pokemon: { img: imgBasehref + "380.png", name: "Latias" }, method: "Roaming Kanto after Steven Stone" },
        { pokemon: { img: imgBasehref + "381.png", name: "Latios" }, method: "Roaming Kanto after Steven Stone" }
      ]
    },
    "pre-elite-4-kanto": {
    ...
    red: {
      ...
      rows: [
        ...
        },
        {
          ...
          method: "Breed Mantine holding Wave Incense"
        },
    ...
    postgame: {
      ...
      rows: [
        ...
        /* ================= Hoenn Legendary ================= */
        {
          ...
          method: "Embedded Tower with Blue Orb"
        },
        {
          pokemon: { img: imgBasehref + "383.png", name: "Groudon" },
          method: "Embedded Tower with Red Orb"
        }
      ]
    }
  }
