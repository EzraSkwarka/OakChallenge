...
window.gameData = {
  gameId: "diamond",
  gameTitle: "Diamond",
  logo: "assets/images/logos/diamond.png",
  aboutHtml: `
  ...
  `,
    ...
    "maylene-wake": {
      ...
      headerImgAlt:
        "Maylene as she appeared in Pokémon Diamond and Pearl",
      ...
      summaryHtml: `
        ...
        <h5>Route 209</h5>
        <pre>
          Mime Jr → Level up knowing Mimic → Mr. Mime
        </pre>
  ...
  `,
      ...
      rows: [
        ...
        /* ---------------- Route 206 ---------------- */
        {
          pokemon: { img: imgBasehref + "434.png", name: "Stunky" },
          method: "Route 206",
        },
        {
          pokemon: { img: imgBasehref + "435.png", name: "Skuntank" },
          method: "Evolve from Stunky at level 34",
        },
        {
        ...
        },
        {
          ...
          method: "Evolve Mime Jr. knowing Mimic",
        },
  ...
  `,
      ...
      rows: [
        /* --------------------------- Mt Coronet (gated) ------------------------- */
        {
          pokemon: { img: imgBasehref + "483.png", name: "Dialga" },
    ...
    "pre-elite-four": {
      ...
      headerImgAlt:
        "Cynthia as she appeared in Pokémon Diamond and Pearl",
    ...
    "post-game": {
      ...
      summaryHtml: `<p>
        ...
        <pre>
          ...
          (Route 207) Larvitar → Lv. 30 → Pupitar → Lv. 55 → Tyranitar
          (Route 210 North) Kecleon
        ...
        <pre>
          ...
          Bonsly → Lv up knowing Mimic → Sudowoodo
        </pre>
        ...
        <p>
          And surfing in the waters will let you encounter Seel
        </p>
        <pre>
          Seel → Lv. 34 → Dewgong
        </pre>
  ...
  ${guideSource}`,
      ...
      rows: [
        ...
        {
          pokemon: { img: imgBasehref + "246.png", name: "Larvitar" },
          method: "Pokeradar (Route 207)",
        },
        {
          pokemon: { img: imgBasehref + "247.png", name: "Pupitar" },
          method: "Evolve from Larvitar at level 30",
        },
        {
          pokemon: { img: imgBasehref + "248.png", name: "Tyranitar" },
          method: "Evolve from Pupitar at level 55",
        },

        {
          pokemon: { img: imgBasehref + "352.png", name: "Kecleon" },
          method: "Pokeradar (Route 210 North)",
        },
        ...
        {
          pokemon: { img: imgBasehref + "262.png", name: "Mightyena" },
          method: "Pokeradar (Route 214)",
        },
        ...
        {
          pokemon: { img: imgBasehref + "304.png", name: "Aron" },
          method: "Pokeradar (Fuego Ironworks)",
        },
        {
          pokemon: { img: imgBasehref + "305.png", name: "Lairon" },
          method: "Evolve Aron at level 32",
        },
        {
          pokemon: { img: imgBasehref + "306.png", name: "Aggron" },
          method: "Evolve Lairon at level 42",
        },
        ...
        {
          pokemon: { img: imgBasehref + "261.png", name: "Poochyena" },
          method: "Breed Mightyena",
        },
        ...
        },
        {
          ...
          method: "(Diamond) Daily Trophy Garden Pokémon",
        },
        {
...

        {
          ...
          method: "(Diamond) Surf (Route 226)",
        },
        {
          pokemon: { img: imgBasehref + "087.png", name: "Dewgong" },
          method: "Evolve Seel at level 34",
        },
        ...
        {
          pokemon: { img: imgBasehref + "123.png", name: "Scyther" },
          method: "(Diamond) Route 229",
        },
